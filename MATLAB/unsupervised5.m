...
% This requires the 'silhouette' function from MATLAB
silhouetteScore = silhouette(trainReducedFeatures, clusterIndices);
disp(['Silhouette Score: ', num2str(mean(silhouetteScore))]);
...
subplot(1,3,2);
% Apply the final centroids to the validation set
...
subplot(1,3,3);
% Apply the final centroids to the test set
