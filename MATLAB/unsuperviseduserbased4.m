...
specifies that the performance function of an autoencoder neural network (here named autoenc) 
should use Mean Squared Error (MSE) to evaluate how well it is learning.

Mean Squared Error (MSE) is a common performance measure in machine learning that 
calculates the average of the squares of the errors between predicted values and actual values. 
In the context of an autoencoder, 
MSE is used to measure how close the reconstructed output is to the original input.
